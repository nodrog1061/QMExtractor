...
# 30 Sep 23  3.4-12 Fixed QMTrans() and QMRTrans() to accept the correct number of arguments.
...
# QMRTrans()
# ======================================================================
def RTrans(FileName , Id , FieldName , Action):
    """
    ...
    func.restype = ct.c_void_p
    s = func(FileName , Id , FieldName , Action)
    if s is None: return ""
    rec = ct.wstring_at(s)
    __QMFree(s)
    return rec
...
# QMTrans()
# ======================================================================
def Trans(FileName , Id , FieldName , Action):
    """
